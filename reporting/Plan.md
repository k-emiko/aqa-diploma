...
1. Ввод цифр с "0" спереди (например, "01" для января, "09" для сентября). **Ожидаемый результат**: успешная отправка формы.
1. Ввод 3 цифр.
...
* Testcontainers - инструмент, позволяющий запускать тестируемое приложение в контейнере прямо из теста, что упрощает настройку CI.
